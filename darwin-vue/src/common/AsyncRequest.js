...
export const asyncDebugScript = async request => await AxiosRequest.post('/api/debug/debugScript', request, {timeout: 20000})
export const asyncDebugURL = async request => await AxiosRequest.get('/api/debug/debugURL', {params: request, timeout: 20000})
...
export const asyncDownAnalysis = async content_type => await AxiosRequest.get('/api/dashboard/getDownAnalysis', {params: {content_type: content_type}, timeout: 30000})
