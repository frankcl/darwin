...
export const asyncDebugScript = async request => await AxiosRequest.post('/api/debug/debugScript', request)
export const asyncDebugURL = async request => await AxiosRequest.get('/api/debug/debugURL', {params: request})
