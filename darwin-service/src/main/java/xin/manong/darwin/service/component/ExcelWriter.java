...
public class ExcelWriter {
    ...
    public void reset() throws IOException {
        ...
        logger.info("reset excel writer success");
    }
     ...
     * @throws IOException
     */
    public boolean write(String sheetName, Map<String, Object> data) throws IOException {
        ...
        if (writeRows > 0 && writeRows % 200 == 0) {
            ...
            logger.info("write rows[{}] for sheet[{}]", writeRows, sheetName);
        }
        return true;
    }
}
