...
public class SearchQueryBuilderSuite {
    ...
    public void testBuildTermQuery() {
        ...
        }
        {
            ...
            Assert.assertTrue(termQuery != null);
            Assert.assertEquals("key", termQuery.getFieldName());
            Assert.assertEquals(true, termQuery.getTerm().asBoolean());
        }
        {
    ...
    public void testBuildMatchPhraseQuery() {
        ...
        Assert.assertTrue(matchPhraseQuery != null);
    ...
    public void testBuildRangeQuery() {
        {
            ...
            Assert.assertTrue(rangeQuery != null);
